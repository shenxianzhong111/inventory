...
<div class="table-common">  
    <div class="left">
        ...
        <a id="optimize" class="btn btn-primary ajax-get" href="<?php echo url('optimize') ?>" autocomplete="off">优化表</a>
        <a id="repair" class="btn btn-primary  ajax-get" href="<?php echo url('repair') ?>" autocomplete="off">修复表</a>
    </div>
</div> 
        ...
        <tbody>
            <?php foreach ($lists as $table) { ?>
                <tr>
                    ...
                    <td class="action">
                        <a class="btn btn-primary btn-xs ajax-get no-refresh" href="<?php echo url('optimize?tables=' . $table['name']); ?>"><i class="fa fa-recycle"></i> 优化表</a>&nbsp;
                        <a class="btn btn-primary btn-xs ajax-get no-refresh" href="<?php echo url('repair?tables=' . $table['name']); ?>"><i class="fa fa-wrench"></i> 修复表</a>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
