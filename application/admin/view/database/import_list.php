    ...
    <tbody>
        <?php foreach ($lists as $data) { ?>
            <tr>
                ...
                <td>-</td>
                <td class="action">
                    <a class="btn btn-primary btn-xs btn-sm db-import" href="<?php echo url('import?time=' . $data['time']); ?>"> 还原</a>&nbsp;
                    <a class="btn btn-danger btn-xs ajax-get confirm" href="<?php echo url('del?time=' . $data['time']); ?>"> 删除</a>
                </td>
            </tr>
        <?php } ?>
    </tbody>
