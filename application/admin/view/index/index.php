...
<html lang="zh-CN">
    <head>
        ...
        <!-- Bootstrap -->
        <link href="__PUBLIC__/libs/bootstrap/3.3.5/css/bootstrap-icon.css" rel="stylesheet">
        
        <link rel="stylesheet" href="__STATIC__/admin/css/style.css" />
    </head>
    <body>
        <div class="header">
            <div class="dl-title"><img src="__PUBLIC__/static/admin/images/logo.png"></div>
            <div class="dl-main-nav">
                ...
                <ul id="J_Nav"  class="nav-list ks-clear">
                    ...
                    foreach ($menu_list_group as $key => $value) {
                        ...
                        ?>">
                            <div class="nav-item-inner"><i class="<?php echo $value['icon']; ?>"></i> <?php echo $value['name']; ?></div>
                        </li>
                    <?php } ?>
                </ul>
            </div>
