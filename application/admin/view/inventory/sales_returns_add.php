                ...
                <tr>
                    ...
                    <td>
                        <div class="input-prepend input-append">
                            ...
                            <button type="button" class="btn btn-default" onclick="$('#quantityquantity').val((Number($('#quantityquantity').val()) + 1) > {$one.quantity - $one.returns} ? $('#quantityquantity').val() : (Number($('#quantityquantity').val()) + 1))"><i class="glyphicon glyphicon-plus"></i></button>
                        </div>
