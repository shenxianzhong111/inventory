...
<div class="text-left">
    <a href="javascript:history.back(-1);" title="返回" class="btn btn-default"><i class="glyphicon glyphicon-menu-left"></i> 返回</a>
    <a href="javascript:;" 
       class="print btn btn-default"
       title="打印订单{$one.id}"
       num="{$one.order_number}"
       url="<?php echo APP_HOST.url('prints/orders_view', ['id' => $one['id'], 'session_id' => session_id()]) ?>"><i class="glyphicon glyphicon-print"></i> 打印</a>
</div>
<hr>
