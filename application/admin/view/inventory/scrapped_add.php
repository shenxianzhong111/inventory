            ...
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td><div class="input-prepend input-append">
                            ...
                            <button type="button" class="btn btn-default" onclick="$('#quantityquantity').val((Number($('#quantityquantity').val()) + 1) > {$var.quantity} ? $('#quantityquantity').val() : (Number($('#quantityquantity').val()) + 1))"><i class="glyphicon glyphicon-plus"></i></button>
                        </div>
                ...
                <tr>
                    ...
                    <td><button type="submit" class="btn btn-primary ajax-post" target-form='scrapped_add'><i class="glyphicon glyphicon-floppy-disk"></i> 保存</button> </td>
                </tr>
            </table>
        </form>
    </div>
