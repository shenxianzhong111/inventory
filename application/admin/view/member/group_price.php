...
<div class="table-common">
    <div class="left">
        <a class="btn btn-default" href="<?php echo url('member/group') ?>"><i class="glyphicon glyphicon-menu-left"></i> 返回列表</a>
...
<script>
    ...
    require(['jquery', 'bootstrapTable'], function ($, bootstrapTable) {
        $(function () {
