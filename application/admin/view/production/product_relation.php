...
<table class="table table-striped table-hover">
    ...
    foreach ($lists as $key => $value) {
        ...
        <tr>
            ...
            <!--<td><img src="<?php echo img_resize($value['image'], 400, 400) ?>" style="max-width: 100px; max-height: 100px;" class="img-thumbnail" /></td>-->
            <td><?php echo $value['name'] ?></td>
            <td><?php echo $value['bc_count'] > 0 ? $value['bc_count'] : '' ?></td>
            <td>
                <a class="btn btn-success btn-xs" href="<?php echo url('product_relation_edit', ['id' => $value['id']]) ?>">配置关联</a>
            </td>
        </tr>
    <?php } ?>
</table>
